...
class DynamicLoading2(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_FirstScenario(self): #Failed due less wait time
    ...
    def test_SecondScenario(self):#passed
        self.driver.implicitly_wait(15)
        self.driver.find_element_by_xpath('//*[contains(text(),"Start")]').click()
        actual_output = self.driver.find_element_by_id("finish").text
        self.assertEqual(actual_output,"Hello World!")

    def test_ThirdScenario(self):#Failed due no wait
        self.driver.find_element_by_xpath('//*[contains(text(),"Start")]').click()
        actual_output = self.driver.find_element_by_id("finish").text
        self.assertEqual(actual_output,"Hello World!")
